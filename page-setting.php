        ...
        <div class="content">
                ...
                <div class="the-left">
                    <div class="s-nav-ite"><svg width="15" height="18" viewBox="0 0 15 18" fill="none"
                            ...
                            // print_r($user);
                                ...
                                if( is_array($user->roles)  && array_intersect($user->roles,['author','administrator'])  || !is_user_logged_in() ){
                                    echo"<div id='prompt_nav' class='s-nav-item active'>Prompts</div>";
                                    }
                                    

                            if(  is_array($user->roles)  && array_intersect($user->roles,['subscriber','author','administrator'])  ){
                                echo"
                                <div class='s-nav-item '>Profile</div>";
                                }
            ...
            <div class="setting-content-cover">
                ...
                if( is_array($user->roles)  && array_intersect($user->roles,['author','administrator']) ){
                   ...
                   if( is_array($user->roles)  && array_intersect($user->roles,['author','subscriber','administrator'])  ){
